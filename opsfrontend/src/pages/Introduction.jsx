...
export default function IntroductionPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-[#121212] text-gray-900 dark:text-gray-100 transition-colors flex flex-col">
      ...
      <div className="flex flex-1 flex-col items-center justify-center text-center px-6 space-y-6 mt-[-200px]">
        ...
        <div className="flex items-center z-10 gap-4 justify-center mt-12">
          ...
          >
            {isAuthenticated ? "Get Back" : "Get Started"} 
          </button>
          <button
            onClick={() => setShowKnowMore(true)}
            className="px-6 py-3 rounded-full text-white text-lg font-bold bg-gray-700 hover:bg-gray-800 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 hover:scale-105 active:scale-95 border-0 focus:outline-none focus:ring-4"
          >
            Know More
          </button>
        </div>
          ...
          <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-3xl p-8 md:p-12 max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-white/20 dark:border-gray-700/50">
            ...
            <div className="space-y-6 text-left">
              <div>
                ...
                <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                  <li className="flex items-start gap-3"><span className="text-orange-500 font-bold text-xl mt-0.5">✓</span>Real-time team collaboration</li>
                  <li className="flex items-start gap-3"><span className="text-orange-500 font-bold text-xl mt-0.5">✓</span>Task & project management</li>
                  <li className="flex items-start gap-3"><span className="text-orange-500 font-bold text-xl mt-0.5">✓</span>Advanced analytics dashboard</li>
                  <li className="flex items-start gap-3"><span className="text-orange-500 font-bold text-xl mt-0.5">✓</span>Custom workflows & automation</li>
                </ul>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-10 pt-6 border-t border-gray-200 dark:border-gray-700">
              <button
                ...
                className="flex-1 px-6 py-3 rounded-xl text-white font-bold bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Start Free Trial
              </button>
              <button
                onClick={() => setShowKnowMore(false)}
                className="px-6 py-3 rounded-xl text-gray-700 dark:text-gray-300 font-medium border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200"
              >
                Close
              </button>
            </div>
