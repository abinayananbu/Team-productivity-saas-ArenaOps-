        ...
        <div className="flex flex-col gap-2 p-3">
          {tasks.map((task) => (
            <div
              ...
              className="cursor-pointer flex justify-between items-center px-6 py-5 rounded-xl border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[#2a2b2e] hover:border-indigo-300 dark:hover:border-indigo-700 transition-all duration-200 group"
            >
